...
export default function InputForm({ onFetchWeather }: InputFormProps) {
  ...
  return (
    <form
      ...
      className="w-4/5 max-w-md bg-white p-8 rounded-lg shadow-lg space-y-6"
    >
      <h2 className="text-3xl font-semibold text-gray-800">Get Weather</h2>
      <div>
        <label className="block text-gray-600 text-sm">City Name</label>
        <input
          type="text"
          // register w hook form -- validations
